...
def main():
    ...
    parser.add_argument("-l", "--length", default=10.0, type=float, help="The length of the rectangle.")
    parser.add_argument("-w", "--width", default=5.0, type=float, help="The width of the rectangle.")
